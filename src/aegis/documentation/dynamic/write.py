...
def write_dictlists_as_markdown_table(dict_list, path):
    ...
    with open(path, "w") as file_:
        file_.writelines(specifications.output_specifications_preamble)
        file_.writelines(md)
...
write_dictlists_as_markdown_table(specifications.output_specifications, path=here / "output_specifications.md")
