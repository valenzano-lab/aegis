...
DEFAULT_PARAMETERS = {
    ...
    "STEPS_PER_SIMULATION": Parameter(
        ...
        domain="other",
        default=100000,
        info="How many steps does the simulation run for?",
        dtype=int,
        drange="[1, inf)",
    ...
    "LOGGING_RATE": Parameter(
        ...
        domain="recording",
        default=1000,
        info="Log every ?-th step; 0 for no logging",
        dtype=int,
        drange="[0, inf)",
        inrange=lambda x: x >= 0,
        evalrange=[1, 10000],
    ...
    "PICKLE_RATE": Parameter(
        ...
        domain="recording",
        default=100000,
        info="Pickle population every ? steps; 0 for no pickles",
        dtype=int,
        drange="[0, inf)",
        inrange=lambda x: x >= 0,
    ...
    "SNAPSHOT_RATE": Parameter(
        ...
        domain="recording",
        default=10000,
        info="Take a snapshot every ? steps; 0 for no snapshots",
        dtype=int,
        drange="[0, inf)",
        inrange=lambda x: x >= 0,
        serverrange=lambda x: x >= 1000 or x == 0,
    ...
    "VISOR_RATE": Parameter(
        ...
        domain="recording",
        default=1000,
        info="Take a visor snapshot every ? steps; 0 for no visor records",
        dtype=int,
        drange="[0, inf)",
        inrange=lambda x: x >= 0,
        evalrange=[1, 10000],
    ...
    "TE_DURATION": Parameter(
        ...
        domain="recording",
        default=500,
        info="Number of steps to record TEs",
        dtype=int,
        drange="[0, inf)",
        inrange=lambda x: x >= 0,
        evalrange=[1, 10000],
    ...
    "POPGENSTATS_RATE": Parameter(
        ...
        domain="recording",
        default=1000,
        info="Record population genetic stats about the population every ? steps; 0 for no popgen stats",
        dtype=int,
        drange="[0, inf)",
        inrange=lambda x: x >= 0,
    ...
    "INCUBATION_PERIOD": Parameter(
        ...
        domain="reproduction",
        default=0,
        info="How many steps does it take from fertilization to hatching? 0 if egg period is skipped, -1 if hatching occurs only once no living individuals are around.",
        dtype=int,
        drange="[-1, inf)",
        inrange=lambda x: x >= -1,
        presets={},
    ...
    "ENVDRIFT_RATE": Parameter(
        ...
        default=0,
        info="Fitness landscape is modified every ? steps",
        dtype=int,
        drange="[0, inf)",
        inrange=lambda x: x >= 0,
    ),
    ...
    "ABIOTIC_HAZARD_OFFSET": Parameter(
        ...
        domain="abiotic",
        default=0,
        info=r"e.g. 0.01 means that abiotic mortality is increased by 1% each step",
        dtype=float,
        drange="[0, inf)",
        inrange=lambda x: x >= 0,
    ),
