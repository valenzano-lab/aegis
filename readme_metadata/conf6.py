...
output_prefix = "scen4_dieoff" # Prefix for output files within simulation directory
output_mode = 1 # 0 = return records only, 1 = return records + final pop,
                # 2 = return records + all snapshot populations
age_dist_N = 100 # Window size around snapshots stage/generation for no_auto/auto
...
kill_at = 1000 # stage/generation for no_auto/auto repectively at which to force
            # dieoff, 0 if none
