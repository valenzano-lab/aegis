...
age_dist_N = 100 # Window size around snapshots for which to record age_dist
...
starve_at = 1000   # stage/generation for no_auto/auto repectively at which to force
