...
## CORE PARAMETERS ##
random_seed = "scen4.prng_seed" # If numeric, sets random seed to that value before execution
...
output_prefix = "scen4_all_age_dist" # Prefix for output files within simulation directory
